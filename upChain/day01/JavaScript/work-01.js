...
// 声明自己的昵称 string类型的值
// const myNickname = Buffer.from('MagicalBridge')
...
//   if(hash.startsWith('0000') && hash[4] !== '0') {
//     break
//   }
...
let { nonce: nonce1, hash:hash1, runTime:runTime1 } = calculateTime('MagicalBridge','00000',5)
